...
def mod_process_data(df_preprocess, start_train, endin_train, start_valid, endin_valid, start_tests, endin_tests, lags, n_features,type_split):
    ...
    if type_split == 'TRVAL':
        ...
        y_tests_date = mod_pipeline(df_preprocess, start_train, endin_train, start_valid, endin_valid, start_tests, endin_tests, lags, n_features, 'y_tests_date')
